...
const WideText = () => {
  ...
  const convertToWideText = () => {
    const wideText = text.split("").join(" ");
    setText(wideText);

    toast({
      title: "🚀 Text Converted!",
      description: "Your text has been converted to wide text.",
      duration: 2000,
    });
  };
    ...
    <section className="flex flex-col gap-2">
      ...
      <div className="flex flex-col items-start justify-between gap-4 lg:flex-row lg:items-center">
        ...
        <div className="flex w-full flex-col gap-2 lg:w-fit lg:flex-row">
          ...
          <Button onClick={convertToWideText}>Convert</Button>
        </div>
      </div>
    </section>
  );
